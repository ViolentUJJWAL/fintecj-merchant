...
const isEncrypted = (value) => {
  // Assuming your encryption adds some specific prefix or structure to the encrypted data.
  return value.startsWith("enc:"); // Adjust this check based on your encryption logic.
};
